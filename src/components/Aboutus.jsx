...
const Aboutus = () => {
  return (
    <>
      <div className="bg-[#D9D9D9] w-[300px] h-[625px] md:w-[500px] md:h-[575px] rounded-xl">
        <div className="p-11">
        ...
        <button className="ml-[15%] mt-[5%] md:mt-[35%] md:ml-[30%] border-2 rounded-xl border-solid border-black bg-white p-4 md:hover:bg-red-200 transition duration-200"> GO TO PROFILE PAGE </button>
      </div>
    </>
  )
}
